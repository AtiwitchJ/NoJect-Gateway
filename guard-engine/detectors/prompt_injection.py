...
class PromptInjectionDetector:
    ...
    DIRECT_INJECTION_PATTERNS = [
        ...
        r"(?i)\b(reveal|output|print|display|dump|leak|repeat|show)\s+(your\s+|the\s+)?(system\s+prompt|initial\s+prompt|secret\s+(instructions|directives|prompt|api\s+key)|hidden\s+prompt)",
        ...
        r"(?i)<<\s*SYS\s*>>|<\|im_start\|>system|<system>|\[SYSTEM\s+PROMPT\]",
